...
<div align="center">
    ...
    <br>
    Due to constant Discord terminations I will not be making a new support server. For urgent contact: <a href="https://t.me/ilikenigger">Telegram</a>
</div>
...
4. Run the builder by double clicking the `build.bat and build.py` file
...
<div align="center">
    ...
    <img style="border-radius: 15px; display: block; margin-left: auto; margin-right: auto; margin-bottom:20px;" width="70%" src="img/frenzy-Hit.png"></img>
    ...
    <img style="border-radius: 15px; display: block; margin-left: auto; margin-right: auto; margin-bottom:20px;" width="70%" src="img/frenzy-Hit2.png"></img>
</div>
